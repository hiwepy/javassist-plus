package com.github.hiwepy.javassist;
 ...
 */
public class JavassistExample4 {

	@Test
	public void createDynamicClazz() throws Exception {
		
		ClassPool pool = ClassPool.getDefault();
		
		// 创建类
		CtClass cc = pool.makeClass("com.github.hiwepy.javassist.DynamicHelloWorld");
