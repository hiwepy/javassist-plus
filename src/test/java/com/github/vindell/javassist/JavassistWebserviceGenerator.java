...
public class JavassistWebserviceGenerator {
	...
	public Class<?> createDynamicInterface() throws Exception {
		...
		// 创建类
		CtClass cc = pool.makeInterface("org.apache.cxf.spring.boot.IDynamicHelloWorld",
				pool.getCtClass("java.lang.Cloneable"));
		...
		ctMethod.setModifiers(Modifier.PUBLIC);
		/*
		 * StringBuffer body = new StringBuffer(); body.append("{");
		 * body.append("\n    System.out.println($1);");
